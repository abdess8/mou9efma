...
<head>
	...
	<title>MOU9EF - Inscription</title>
...
<body>
	...
	<div id="notfound">
		...
		<div class="notfound">
			...
			<h2>Voulez vous s'inscrire autant que</h2>
			<a href="signupmem.php" class="contact-btn">Membre</a>
			<a href="signupemp.php" class="contact-btn">Professionnel</a>
