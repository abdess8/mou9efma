...
<head>
    ...
    <link rel="stylesheet" href="css/avantmain.css">
...
<body data-spy="scroll" data-target="#navbar" data-offset="120" >
    ...
    <div id="header">
        ...
        <div class="bottom text-center">
            <a id="scrollArrow" href=""><i class="fa fa-chevron-left"></i></a>
            <a id="scrollArrow" href="index2ar.php">Arabe<i class="fa fa-chevron-right"></i></a>
        
            <a id="scrollArrow" href="">&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-chevron-left"></i></a>
            <a id="scrollArrow" href="index2.php">Français<i class="fa fa-chevron-right"></i></a>
