...
if (isset($_POST['submit'])) {
    ...
    $sql = "insert into signupmem(firstname,lastname,phoneuser,gender,ville,email,password) values ('$firstname','$lastname','$phoneuser','$gender','$ville','$email','$password')";
    if ($db->query($sql) === true) {
      $_SESSION['message']= "Registration Successful.";
      header("location: loginmem.php");
    }else {
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 form-box">
                            ...
                            <div class="form-bottom">
			                    ...
			                    <form role="form" action="signupmem.php" method="post" class="registration-form">
