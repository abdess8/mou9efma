...
if (isset($_POST['submit'])) {
  ...
  if (empty($_POST['email']) || empty($_POST['password'])) {
    ...
    $ins = "insert into loginemp (email,password) values ('$email','$password')";
...
<html lang="en">
    ...
    <title>MOU9EF - Espace Professionnel</title>
                        ...
                        <div class="col-sm-5 form-box">
                        	<div class="form-top">
                        		<div class="form-top-left">
                        			<h3>Bonjour Cher(e) Professionnel(le)</h3>
                            ...
                            <div class="form-bottom">
                              ...
                              <form method="post" action="loginemp.php">
                                  ...
                                  <p align="center">Nouveau Employé(e)? <a href="signupemp.php">Inscrivez Vous!</a></p>
                                 </div>
