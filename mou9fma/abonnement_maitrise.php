...
<head>
    <title>MOU9EF - Abonnement Maitrisé</title>
    ...
    <link rel="stylesheet" href="css/abon_maitrise.css">
    ...
    <div id="header">
        ...
        <div class="center text-center">
            ...
            <div class="banner">
                ...
                <h1 class="">Abonnement Maitrisé</h1>
            </div>
            
            <div class="subtitle"><h4>Grâce à l'Abonnement Maîtrisé, Profitez en toute sérénité sans vous soucier de votre facture.</h4></div>
            
        </div>
        
        <div class="bottom text-center">
            <a id="scrollLeftArrow" href=""><i class="fa fa-chevron-left"></i></a>
            <a id="scrollRightArrow" href="signupindex.php">S'inscire<i class="fa fa-chevron-right"></i></a>
        
            <a id="scrollLeftArrow" href="">&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-chevron-left"></i></a>
            <a id="scrollLeftArrow" href="se_connecte.php">Se connecter<i class="fa fa-chevron-right"></i></a>
            <p></p>
